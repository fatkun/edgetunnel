...
let subconfig = "https://raw.githubusercontent.com/fatkun/bestcf/main/ACL4SSR.ini"; //订阅配置文件
		...
		try {
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				case `/${userID}`: {
					...
					const vlessConfig = await getVLESSConfig(userID, request.headers.get('Host'), actualSub, UA, RproxyIP, url);
					const now = Date.now();
